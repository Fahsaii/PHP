...
echo "<html>";
echo "<head>";
echo "<title>การสร้างฟอร์มในการรับค่าเพื่อคำนวณ</title></head>";
echo "<body>";
echo "<form method='get' action='test_lab5-9.php'>";
echo "<table border='1' align='center' width='500'>";
    ...
    echo "<tr>";
        ...
        echo "<td><input type='number' name='number1' min='1' size='15' value=''/> </td>";
    echo "</tr>";
        echo "<td>Enter Number 2 : </td>";
        echo "<td><input type='number' name='number2' min='1' size='15' value=''/></td>";
    echo "</tr>";
    echo "<tr>";
    echo "<td> Operator : </td>";
