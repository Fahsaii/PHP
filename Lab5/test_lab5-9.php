...
<body>
<form method="get" action="test_lab5-9.php">
<table border="1" align="center" width="500">
    ...
    <tr>
        ...
        <td><input type="number" name="number1" min="1" size="15" value=""/> </td>
    </tr>
        <td>Enter Number 2 : </td>
        <td><input type="number" name="number2" min="1" size="15" value=""/></td>
    </tr>
    <tr>
    <td> Operator : </td>
        <td align="center">
